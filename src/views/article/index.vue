<template>
    ...
    <div style="display: flex;margin: 50px auto;">
        <MdPreview showCodeRowNumber :editorId="state.id" :modelValue="text" style="width: 50%" />
        <MdCatalog @onClick="click" :editorId="state.id" :scrollElement="scrollElement"
            style="width: 30%;" />
    </div>
</template>
