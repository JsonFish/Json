<template>
    <div class="message">
        <div class="top">
            <vue-danmaku ref="danmakuRef" v-model:danmus="danmus" useSlot loop style="height:100vh; width:100%;"
                :autoplay="true" randomChannel :channels="23">
                <template v-slot:dm="{ danmu }">
                    <div>
                        <el-avatar :size="30" shape="circle" :src="danmu.avatar" fit="cover"></el-avatar>
                        <span style="color: skyblue;">{{ danmu.name }}: {{ danmu.text }}</span>
                    </div>
                </template>
            </vue-danmaku>
        </div>
...
const danmus = ref([{ avatar: 'http://sa6qp7vwh.hb-bkt.clouddn.com/1710421774015.png', name: 'Json', text: '666' }, { avatar: 'http://sa6qp7vwh.hb-bkt.clouddn.com/1710421774015.png', name: 'Tom', text: '81632718361' }, { avatar: 'http://sa6qp7vwh.hb-bkt.clouddn.com/1710421774015.png', name: 'bgvjab', text: '公司大的公司在' }, { avatar: 'http://sa6qp7vwh.hb-bkt.clouddn.com/1710421774015.png', name: '固定方式', text: '不大方便' }, { avatar: 'http://sa6qp7vwh.hb-bkt.clouddn.com/1710421774015.png', name: '高大上覆盖的', text: '对方是个斯蒂芬' }])
